...
if (file_exists(realpath(__DIR__ . "/../../assets/webutama/assets\Bizpage/lib/res/broken_image.png"))) {
    Cache::$broken_image = realpath(__DIR__ . "/../../assets/webutama/assets\Bizpage/lib/res/broken_image.png");
}