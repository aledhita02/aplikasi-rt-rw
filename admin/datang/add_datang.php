	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nama_datang" name="nama_datang" placeholder="Nama Tamu" required>
				</div>
			</div>
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Alamat Kunjungan</label>
				<div class="col-sm-6">
...
if (isset($_POST['Simpan'])) {
	...
	$sql_simpan = "INSERT INTO tb_datang (nik, nama_datang, jekel, id_kk, tgl_datang, waktu, alamat_kunjung, alasan, pelapor) VALUES (
			'" . $_POST['nik'] . "',
			'" . $_POST['nama_datang'] . "',
			'" . $_POST['jekel'] . "',
			'" . $_POST['id_kk'] . "',
