	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="tempat" name="tempat" placeholder="Tempat Kejadian" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="makam" name="makam" placeholder="Tempat Pemakaman" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_mendu (id_pdd, tgl_mendu, waktu, sebab, tempat, makam) VALUES (
			'".$_POST['id_pdd']."',
            '".$_POST['tgl_mendu']."',
			'".$_POST['waktu']."',
            '".$_POST['sebab']."',
